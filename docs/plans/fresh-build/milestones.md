...
### Integration Requirements
- [ ] Library loader integrates with config system
...
**Files:** [`internal/library/loader.go`], [`internal/prompt/prompt.go`]
...
### Integration Requirements
- [ ] API client integrates with config system
